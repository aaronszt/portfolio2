    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.classP}>
                <p>
                    <a href="https://api-pokemon-frontend.vercel.app/" target="_blank" rel="noreferrer noopener">
                        <FontAwesomeIcon icon={icon({ prefix: 'fas', iconName: 'share-square', style: 'light' })} /> REST API&nbsp;&nbsp;
                    </a>
                    ...
                    <br></br>
                    REST API. A page with 'Pokemon' content, complete CRUD, user management. Technologies used: .NET 8, CQRS, MediatR, Unit of Work, Repository, PostgreSQL, Sequelize, React, React Redux, HTML, CSS, Docker.
                </p>
            </div>
